    ...
    return (
      <>
        ...
        <div className="p-5 bg-gradient-to-br from-black to-white">
          <h3 className="mb-5 text-xl font-bold">What is DevOdyssey?</h3>
          <p className="text-justify">
            ...
            illo, natus eveniet alias labore corporis! Tempora officia
            temporibus, nam quam praesentium distinctio iusto, accusamus modi
            nostrum inventore assumenda voluptas aut unde.
          </p>

          <h3 className="mt-12 mb-5 text-xl font-bold">About</h3>
          <div className="flex items-center justify-between gap-5">
            <p className="text-justify">
              Lorem ipsum dolor sit amet consectetur, adipisicing elit.
              Voluptates placeat sapiente distinctio quas ut qui officiis error
              est impedit quo? At optio corporis, dignissimos illo voluptate
              fugiat expedita blanditiis eveniet doloribus! Numquam modi maxime
              aspernatur? Quod, adipisci harum cumque nobis in eos
              necessitatibus! Non nesciunt aliquam beatae excepturi quasi
              suscipit quam maxime officiis doloremque vitae sequi saepe,
              voluptatum voluptatem eaque.
            </p>
          ...
          <h3 className="mt-12 mb-5 text-xl font-bold">Featured Blogs</h3>
          <div className="relative w-full max-w-2xl mx-auto overflow-hidden" onMouseEnter={() => setPaused(true)} onMouseLeave={() => setPaused(false)}>
